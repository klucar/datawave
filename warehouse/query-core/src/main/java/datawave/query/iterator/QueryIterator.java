...
public class QueryIterator extends QueryOptions implements YieldingKeyValueIterator<Key,Value>, JexlContextCreator.JexlContextValueComparator,
    ...
    protected IteratorBuildingVisitor createIteratorBuildingVisitor(Class<? extends IteratorBuildingVisitor> c, final Range documentRange,
        ...
        return c.newInstance().setSource(this, this.myEnvironment).setTimeFilter(this.getTimeFilter()).setTypeMetadata(this.getTypeMetadata())
                        ...
                        .setIvaratorCacheDirConfigs(this.getIvaratorCacheDirConfigs()).setQueryId(this.getQueryId()).setScanId(this.getScanId())
                        ...
                        .setIvaratorMaxOpenFiles(this.getIvaratorMaxOpenFiles()).setIvaratorNumRetries(this.getIvaratorNumRetries())
                        .setIvaratorSources(this, this.getMaxIvaratorSources()).setIncludes(indexedFields)
